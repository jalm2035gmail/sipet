...
from fastapi_modulo.core.image_utils import image_info
from fastapi_modulo.modulos_sipet.aplicaciones.repositorios.package_repository import get_module_image_path
