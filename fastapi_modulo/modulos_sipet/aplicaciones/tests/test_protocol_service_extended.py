...
from fastapi_modulo.modulos_sipet.aplicaciones.servicios import protocol_service
...
def test_build_manifest_payload_detects_web_dependency(tmp_path: Path) -> None:
    ...
    (module_dir / "sample.py").write_text("from fastapi_modulo.modulos_sipet.web.servicios.auth_service import x\n", encoding="utf-8")
