...
from fastapi_modulo.modulos_sipet.aplicaciones.repositorios.package_repository import get_module_upload_root
from fastapi_modulo.modulos_sipet.aplicaciones.repositorios import persistence_repository
...
def test_registry_state_and_audit_persistence(monkeypatch) -> None:
    ...
    monkeypatch.setattr(persistence_repository, "_admin_session", lambda: testing_session_local())
