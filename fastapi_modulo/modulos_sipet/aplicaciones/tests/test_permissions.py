...
def test_permissions_allow_explicit_screen_grants(monkeypatch) -> None:
    request = _request()
    monkeypatch.setattr(
        "fastapi_modulo.modulos_sipet.web.servicios.access_service.is_admin_or_superadmin",
        lambda req: False,
    )
    monkeypatch.setattr(
        "fastapi_modulo.modulos_sipet.web.servicios.access_service.get_user_app_access",
        lambda req: [],
    )
    monkeypatch.setattr(
        "fastapi_modulo.modulos_sipet.web.servicios.access_service.get_user_screen_access_levels",
        lambda req: {
