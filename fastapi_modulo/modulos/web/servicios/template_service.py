...
from fastapi_modulo.modulos.web.servicios.template_context_service import (
...
BACKEND_BASE_TEMPLATE = "modulos/web/vistas/base_backend.html"
LOGIN_TEMPLATE = "web_login.html"
NOT_FOUND_TEMPLATE = "not_found.html"
NO_ACCESS_TEMPLATE = "modulos/web/vistas/no_access.html"
...
def build_view_buttons_html(view_buttons: Optional[List[Dict]]) -> str:
    from fastapi_modulo.main import build_view_buttons_html as core_build_view_buttons_html

    return core_build_view_buttons_html(view_buttons)
