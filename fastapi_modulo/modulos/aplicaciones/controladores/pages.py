...
from fastapi_modulo.modulos.web.servicios.module_tools import render_backend_page_html, text_asset_response
...
def aplicaciones_page(request: Request):
    ...
    return render_backend_page_html(
        ...
        content=load_aplicaciones_page(decorate_modules_payload()),
