...
def _screen_permission_enabled(request: Request, permission_key: str) -> bool:
    from fastapi_modulo.modulos.web.servicios.access_service import get_user_screen_access_levels, is_admin_or_superadmin
...
def _get_applications_access_level(request: Request) -> str:
    from fastapi_modulo.modulos.web.servicios.access_service import get_user_app_access, is_admin_or_superadmin
...
def request_actor_context(request: Request) -> dict[str, str]:
    from fastapi_modulo.modulos.web.servicios.auth_service import request_ip, request_tenant_id
