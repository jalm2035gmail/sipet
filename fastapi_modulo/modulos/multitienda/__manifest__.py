MANIFEST = {'name': 'multitienda',
 ...
 'assets': {'css': ['marketplace/static/templates/fields-template.css',
                    'static/css/apartados.css',
                    'static/css/backend-master-detail.css',
                    'static/css/backend-template.css',
                    'static/css/base.css',
                    'static/css/cupones.css',
                    'static/css/empleados.css',
                    'static/css/fidelizacion.css',
                    'static/css/gestion.css',
                    'static/css/ia.css',
                    'static/css/inicio.css',
                    'static/css/institucion-financiera.css',
                    'static/css/multitienda-shell.css',
                    'static/css/productos.css',
                    'static/css/proveedores.css',
                    'static/css/referidos.css',
                    'static/css/repartidores.css',
                    'static/css/reservaciones.css',
                    'static/css/seguidores.css',
                    'static/css/sidebar.css',
                    'static/css/subastas.css',
                    'static/css/tienda.css',
                    'static/css/videos.css',
                    'static/css/whatsapp.css'],
            'js': ['static/js/backend-config.js',
                   'static/js/backend-master-detail.js',
                   'static/js/backend-navbar.js',
                   'static/js/backend-sidebar.js',
                   'static/js/backend-sidebar-core.js',
                   'static/js/carrito.js',
                   'static/js/multitienda-productos.js',
                   'static/js/sidebar-theme-editor.js',
                   'static/js/tienda.js'],
