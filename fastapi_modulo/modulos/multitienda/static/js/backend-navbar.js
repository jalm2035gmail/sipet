(function () {
  ...
  const DEFAULT_AVATAR = "/multitienda/multitienda/static/imagenes/cc.png";
        ...
        <div class="backend-view-kanban">
          <div class="backend-view-kanban-col">
            ...
            <div class="backend-view-kanban-card">
              <div class="backend-view-kanban-media"><img src="/multitienda/static/imagenes/tunegociovaleinv.png" alt="Tienda Centro" /></div>
          ...
          <div class="backend-view-kanban-col">
            <h4>En revisión</h4>
            <div class="backend-view-kanban-card">
              <div class="backend-view-kanban-media"><img src="/multitienda/static/imagenes/tunegociovaleinv.png" alt="Tienda Este" /></div>
              <div class="backend-view-kanban-content">
          ...
          <div class="backend-view-kanban-col">
            <h4>Activo</h4>
            <div class="backend-view-kanban-card">
              <div class="backend-view-kanban-media"><img src="/multitienda/static/imagenes/tunegociovaleinv.png" alt="Tienda Norte" /></div>
              <div class="backend-view-kanban-content">
            ...
            <div class="backend-view-kanban-card">
              <div class="backend-view-kanban-media"><img src="/multitienda/static/imagenes/tunegociovaleinv.png" alt="Tienda Sur" /></div>
              <div class="backend-view-kanban-content">
  ...
  function initEntityViews() {
        ...
        if (isStoreScreen) {
          ...
          entitiesCache = Array.isArray(stores) ? stores.map(function (store) {
            ...
            return {
              ...
              image: store.logo || "/multitienda/static/imagenes/tunegociovaleinv.png",
          ...
          entitiesCache = Array.isArray(users) ? users
            ...
            .map(function (user) {
              ...
              return {
                ...
                image: "/multitienda/static/imagenes/tunegociovaleinv.png",
    ...
    function renderEntityViews() {
      const fallbackImage = "/multitienda/static/imagenes/tunegociovaleinv.png";
    ...
    button.addEventListener("click", async function () {
      ...
      if (action === "delete-content") {
        if (isTemplateScreen && templateRoot) {
          ...
          vendorFields.forEach(function (field) {
            if (field.id === "photoImage") {
              field.setAttribute("src", "/multitienda/multitienda/static/imagenes/cc.png");
            } else if (field.type === "checkbox") {
              field.checked = false;
            } else if (field.type === "file") {
              field.value = "";
