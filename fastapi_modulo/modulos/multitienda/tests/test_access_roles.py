...
def test_multitienda_access_roles_define_store_admin_and_seller_profiles() -> None:
    ...
    assert roles["administrador_tienda"]["screen_access_levels"]["/multitienda/productos"]["full_access"] is True
    ...
    assert roles["vendedor_tienda"]["screen_access_levels"]["/multitienda/productos"]["special_permissions"] is True
