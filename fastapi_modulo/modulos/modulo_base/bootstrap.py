...
from fastapi_modulo.modulos.modulo_base.core.permissions import ModulePermissionRegistry
from fastapi_modulo.modulos.modulo_base.core.responses import ModuleResponseBuilder
from fastapi_modulo.modulos.modulo_base.repositorios.common import ensure_modulo_base_schema
...
class ModuloBaseModule(BaseModule):
    ...
    def register_routes(self, app: FastAPI) -> None:
        from fastapi_modulo.modulos.modulo_base.controladores.modulo_base import router
